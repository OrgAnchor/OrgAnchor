...
- `docs/protocol/PURPOSE_EVIDENCE_CHALLENGE_MODEL.md`
...
```text
keep the published alpha toolchain and OrgAnchor self-pilot reproducibly verifiable
...
keep Beacon-first discovery open while measuring its real-world limits
withhold stable-v1 claims until external validation and release consistency justify them
```
