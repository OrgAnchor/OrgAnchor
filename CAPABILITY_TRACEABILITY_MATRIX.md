...
| OA-013 | S5 public challenge, correction, negative evidence, and historical accountability | DESIGN_ONLY | Design Preview | PURPOSE_EVIDENCE_CHALLENGE_MODEL.md; FIRESEED_ALPHA_PLAN.md; FIRESEED_LAUNCH_DECISION_2026-06-01.md | none | tests/fireseed-alpha-plan.test.ts | none | Challenge governance, malicious-reporting controls, historical accountability interpretation, and durable storage are not solved. |
