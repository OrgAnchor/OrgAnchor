...
The OrgAnchor Beacon layer gives every adopting organization a standard,
origin-owned signal that compatible crawlers can recognize once that origin
enters their discovery frontier. It does not guarantee that an unlinked,
unseeded origin will be found globally.
