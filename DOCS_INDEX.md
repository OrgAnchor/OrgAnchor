...
- `EVIDENCE_INTERPRETATION_ADVERSARIAL_EVALUATION.md`: active Fireseed design for testing whether an unfamiliar Agent separates valid identity/package integrity from insufficient product-claim evidence.
