...
try {
  ...
  assertContains(copiedFiles, "docs/evaluations/CAPABILITY_TRACEABILITY_MATRIX.md");
  assertContains(copiedFiles, "docs/evaluations/CAPABILITY_AUDIT_SCENARIOS.md");
  assertContains(copiedFiles, "docs/operations/VISIBLE_ACCEPTANCE.md");
  assertContains(copiedFiles, "docs/protocol/LANGUAGE_COMPATIBILITY.md");
  assertContains(copiedFiles, "docs/outreach/CALL_FOR_FIRESEED_REVIEW.md");
  ...
  assertContains(copiedFiles, "docs/outreach/PUBLIC_EXPLAINER.md");
  assertContains(copiedFiles, "docs/outreach/FIRESEED_VALIDATION_TRACKING_ISSUE.md");
  assertContains(copiedFiles, "docs/operations/FIRESEED_READINESS_GATE.md");
  ...
  assertContains(copiedFiles, "docs/project/PURPOSE_AND_VALUES.md");
  assertContains(copiedFiles, "docs/guides/ADOPTION_PRINCIPLES.md");
  assertContains(copiedFiles, "docs/guides/ADOPTION_GUIDE.md");
  assertContains(copiedFiles, "docs/guides/EXTERNAL_PILOT_RUNBOOK.md");
  assertContains(copiedFiles, "docs/guides/ROOT_AUTHORITY_CUSTODY_GUIDE.md");
  assertContains(copiedFiles, "docs/guides/MIGRATION_GUIDE.md");
  assertContains(copiedFiles, "docs/guides/PUBLISHING_GUIDE.md");
  assertContains(copiedFiles, "docs/operations/RELEASE_INTEGRITY.md");
  assertContains(copiedFiles, "docs/outreach/SHOWCASE_POLICY.md");
  assertContains(copiedFiles, "docs/protocol/VALUE_CONTINUITY_MODEL.md");
  assertContains(copiedFiles, "docs/guides/EVIDENCE_ONBOARDING_GUIDE.md");
  ...
  assertNotContainsPrefix(copiedFiles, "docs/history");
