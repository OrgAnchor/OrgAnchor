...
Future compact and full results should follow `docs/protocol/PURPOSE_EVIDENCE_CHALLENGE_MODEL.md`.
...
For an implementation-oriented guide, see `docs/protocol/AGENT_INTEGRATION_GUIDE.md`.
