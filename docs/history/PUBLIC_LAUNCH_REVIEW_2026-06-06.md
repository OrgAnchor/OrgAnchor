...
Status: Historical record. Original status at publication: PASS for public-asset preparation, with known alpha limits.
...
- `docs/outreach/FIRESEED_OUTREACH_KIT.md` contained mojibake in the Chinese invitation block. The block was replaced with readable Chinese text.
