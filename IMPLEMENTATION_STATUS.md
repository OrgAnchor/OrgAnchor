...
The current evaluation priority is independent Wave 2 repetition, preferably including a different model provider or independently implemented client. `EXTERNAL_AGENT_EVALUATION_RUNBOOK.md` defines isolation, raw-result preservation, scoring, semantic review, and comparable submission requirements.
